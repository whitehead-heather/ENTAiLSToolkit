...
knitr::include_graphics("Figures/Techniques.jpg")
```
...
* Different vendor data files may require additional filters or modifications to the filters not described here. Please reach out using our [Contact] if you run into issues during conversion. 
...
Koelmel, J. P., *et al*. Interactive software for visualization of nontargeted mass spectrometry data—FluoroMatch visualizer. **Exposome** **2(1)** (2022).  
</div>
...
>     *	CF~3~ at 68.9952 Da  
>     * C~2~F~5~ at 118.9920 Da  
>     * C~3~F~7~ at 168.9888 Da  
>     * C~4~F~9~ at 218.9856 Da  
>     * C~5~F~11~ at 268.9824 Da  
>     * C~6~F~13~ at 318.9792 Da  
>     * C~7~F~15~ at 368.9760 Da  
>
>  &nbsp; 
>
...
>
>  * SO~3~ at 79.9568 Da  
>  * SO~3~H at 80.9646 Da  
>  * SO~3~F at 98.9552 Da  
>  * SO~2~ at 63.9620 Da
...
>
> * Appears as a peak at [M-H-CO~2~]- with CO2 equal to [M-H-43.98989 Da].
>
>  &nbsp;
>
> *Features with sulfonamides in their proposed structure can show specific fragments.*
>
> * NO~2~S at 77.9649 Da
>
>  &nbsp;
>
> *Ether-containing species can show fragments of the carbon fluorine backbone with an additional oxygen.*
>
> * CF~3~O at 84.9901 Da
> * C~2~F~5~O at 134.9869 Da
> * And additional fragments using the structure C~n~F~(2n+1)~O
...
1. A unique (set) of identifiers for the feature, which may include identifiers for both the feature table and earlier raw tables for programs such as FluoroMatch or mzmine. PFAS identified in homologous series can also be given unique homologous series IDs to quickly identify the individual series identified. 
